...
App Bundle 元信息。当前 bundle 标识为 `com.dongdongqiang.cyber-thermometer`，展示名为“动动枪赛博体温计”，版本为 `0.7.1`。`LSUIElement` 为 `true`，表示 App 作为菜单栏应用运行，不显示 Dock 图标。
...
- `RELEASE_NOTES.md`：当前版本发布说明，描述 v0.7.1 的功能和安装信息。
