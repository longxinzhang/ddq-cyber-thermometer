...
func drawDownloadPill(in rect: NSRect) {
    ...
    path.fill()
    drawText("下载 v0.4.0", in: NSRect(x: rect.minX + 30, y: rect.minY + 14, width: rect.width - 60, height: 24), font: .systemFont(ofSize: 20, weight: .bold), color: NSColor(calibratedRed: 0.04, green: 0.1, blue: 0.1, alpha: 1))
}
